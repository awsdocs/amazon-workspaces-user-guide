...
+ [ Chromebooks that support installing Android applications](https://sites.google.com/a/chromium.org/dev/chromium-os/chrome-os-systems-supporting-android-apps)\. Before installing the Android client application, you might need to perform a one\-time operation to [ update your Chromebook to support the installation of Android apps](https://support.google.com/chromebook/answer/7021273)\. In some cases, your WorkSpaces administrator might need to enable your Chromebook to install Android applications\. If you are unable to install the Android client application on your Chromebook, contact your WorkSpaces administrator for assistance\.
...
1. On your device, open [https://clients\.amazonworkspaces\.com/](https://clients.amazonworkspaces.com/) and choose the link for your device\. For [ Chromebooks that support installing Android applications](https://sites.google.com/a/chromium.org/dev/chromium-os/chrome-os-systems-supporting-android-apps), choose **Android Tablet** instead of **Chromebook**\.
